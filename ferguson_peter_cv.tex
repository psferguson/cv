...
% fontawesome is loaded by moderncv itself (fontawesome5 on TeX Live <=2025, fontawesome6 on 2026+); loading it again conflicts
\usepackage{tabularx}
\usepackage{ragged2e}
...
\begin{itemize}[itemsep=1pt, leftmargin=28pt]
    \item [2026] ``\textit{Unveiling Dark Matter with Stellar Streams and Satellite Galaxies in the Era of LSST}",\\
    HEAP Seminar at University of Utah  \hfill Talk
    \item [2026] ``\textit{Unveiling Dark Matter with the Vera C Rubin Observatory}",\\
    Physics Seminar at Weber State  \hfill Talk
...
\item [2026] ``\textit{S5 view of the Jet stream}", S5 Collaboration meeting \hfill Talk
...
\section{MENTORING}
\begin{itemize} [itemsep=1pt, leftmargin=65pt]
    \item [2026-present] Emma Lamb-Smith, an astronomy major at UW Seattle, has worked on using machine learning methods to identify new cluster scale strong lenses in LSST data.
    \item [2025-present] Matthieu Pélissier, a physics PhD student at Université Grenoble Alpes, has worked on measuring the impact of LSST observational systematics on stellar stream density measurements, resulting in a first-author publication.
